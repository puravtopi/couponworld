<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="view_small_business.aspx.cs" Inherits="Coupon.Admin.view_small_business" %>
                    ...
                    <asp:Repeater ID="rpview" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <%-- <td></td>--%>
                                <td>
                                    <a href="<%# "edit_small_business.aspx?sbid="+Eval("int_small_business_id") %>" class="btn btn-primary">Edit</a>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
                            </tbody>
