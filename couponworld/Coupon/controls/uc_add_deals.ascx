<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_add_deals.ascx.cs" Inherits="Coupon.controls.uc_add_deals" %>
                ...
                <ContentTemplate>
                    <div class="login-page" style="padding: 1em 0">
                        <div class="container" style="width: 100%;">
                            ...
                            <asp:RequiredFieldValidator ID="rf4" runat="server" ErrorMessage="Enter Valid Offer Details" ControlToValidate="txt_offer_details" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
