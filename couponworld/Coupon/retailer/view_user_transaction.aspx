<%@ Page Title="" Language="C#" MasterPageFile="~/retailer.Master" AutoEventWireup="true" CodeBehind="view_user_transaction.aspx.cs" Inherits="Coupon.view_user_transaction" %>

<%@ Register Src="~/controls/uc_retailer_sidebar.ascx" TagPrefix="uc1" TagName="uc_retailer_sidebar" %>

<asp:Content runat="server" ID="chead" ContentPlaceHolderID="cpHead">
