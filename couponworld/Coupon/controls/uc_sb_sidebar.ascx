<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_sb_sidebar.ascx.cs" Inherits="Coupon.controls.uc_sb_sidebar" %>
<style>
    li a:hover,
    li a:focus {
        color: #FF5E00;
...
<div>
    <ul style="list-style-type: none">
        <li>
            ...
            <h5 class="item_name"><a href='<%= ResolveUrl("~/sb-profile") %>'><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Profile</a>
            </h5>

            <hr />

            <h5 class="item_name">
                <a href='<%= ResolveUrl("~/sb-deals") %>'><i class="fa fa-gift" aria-hidden="true"></i>&nbsp;Deals</a>
            </h5>

            <hr />

            <h5 class="item_name">
                <a href='<%= ResolveUrl("~/sb-transactions") %>'><i class="fa fa-money" aria-hidden="true"></i>&nbsp;Transactions</a>
            </h5>
