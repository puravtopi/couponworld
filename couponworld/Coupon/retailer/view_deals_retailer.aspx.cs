...
namespace Coupon
{
    public partial class view_deals_retailer : System.Web.UI.Page
    {
        ...
        protected void BindGrid(string query, int pageindex, string columnname = "str_offer_name", string sortorder = "asc")
        {
            try
            {
                ...
                dt = objbal.offer_Select(" where int_retailer_id = " + Session["rid"], pageindex, 10, out totalcount, sortorder, columnname);
