...
{
    public partial class view_sub_category : System.Web.UI.Page
    {
        ...
        protected void BindGrid(string query, int pageindex, string columnname = "str_sub_category_name", string sortorder = "asc")
        {
            try
            {
                int totalcount;
                ...
                dt = objbal.sub_category_Select(query, pageindex, appConstant.pageSize, out totalcount, sortorder, columnname);
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    query = " where str_sub_category_name like '%" + txtsearch.Value + "%' ";
                }
                BindGrid(query, 1);
            }
            catch (Exception ex)
        ...
        protected void lnk_del_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tbl_sub_category_bal objbal = new tbl_sub_category_bal();
                tbl_sub_category_entity objentity = new tbl_sub_category_entity();
                ...
                for (int i = 0; i < rpview.Items.Count; i++)
                {
                    ...
                    {
                        objentity.int_sub_category_id = Convert.ToInt16(hdnID.Value);
                        objbal.sub_category_delete(objentity);
                    }
                }
        ...
        {
            Response.Redirect("edit_sub_category.aspx");
        }
