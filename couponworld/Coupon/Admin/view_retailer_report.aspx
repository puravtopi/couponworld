<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="view_retailer_report.aspx.cs" Inherits="Coupon.Admin.view_retailer_report" %>
            ...
            <asp:UpdatePanel runat="server" ID="upMain">
                <ContentTemplate>
                    <div class="form-inline">
                        ...
                        <br />
                        <div class="col-lg-4">
                            <input type="text" runat="server" id="txt_retailer_name" class="form-control" style="width: 100%" placeholder="Search By Retailer Name" />
                        </div>
                        <div class="col-lg-4">
                            <input type="text" runat="server" id="txt_retailer_no" class="form-control" style="width: 100%" placeholder="Search By Retailer Number" />
                        </div>
                        <div class="col-lg-3">
                    ...
                    <asp:Repeater ID="rpview" runat="server">
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <asp:LinkButton runat="server" ID="LinkButton13" CausesValidation="false" CommandArgument="str_type_name" OnClick="lnk_retailer_name_Click">Retailer Type</asp:LinkButton>
                                                </th>
                                                <th>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <%--<td>
                                    <a href="<%# "retailer_details.aspx?rid="+Eval("int_retailer_id") %>" class="btn btn-primary">Edit</a></td>--%>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
                            </tbody>
            ...
            <label runat="server" id="lbl_total_page" style="display: inline"></label>
                    ...
                    <asp:GridView runat="server" ID="gvtemp" AutoGenerateColumns="false" Visible="false">
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Name" DataField="str_retailer_name" />
                            ...
                            <asp:BoundField HeaderText="Retailer ID" DataField="int_retailer_id" />
