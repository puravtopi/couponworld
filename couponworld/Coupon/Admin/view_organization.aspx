<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="view_organization.aspx.cs" Inherits="Coupon.Admin.view_organization" %>
                    ...
                    <asp:Repeater ID="rpview" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <%-- <td></td>--%>
                                <td>
                                    <a href="<%# "edit_organization.aspx?oid="+Eval("int_organization_id") %>" class="btn btn-primary">Edit</a>
                                    <asp:LinkButton runat="server" ID="lnk_spotlight" CssClass="btn btn-success" CommandArgument='<%# Eval("int_organization_id") %>' OnClick="lnk_spotlight_Click" Visible='<%# Eval("bit_spotlight").ToString() =="True"?false:true %>'>Spotlight</asp:LinkButton>
                                    <asp:LinkButton runat="server" ID="lnk_deactive" CommandArgument='<%# Eval("int_organization_id") %>' OnClick="lnk_deactive_Click" CssClass="btn btn-danger" Visible='<%# Eval("bit_spotlight").ToString() =="False"?false:true %>'>Deactive</asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
