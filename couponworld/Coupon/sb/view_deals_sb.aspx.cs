...
namespace Coupon
{
    public partial class view_deals_sb : System.Web.UI.Page
    {
        ...
        protected void BindGrid(string query, int pageindex, string columnname = "str_offer_name", string sortorder = "asc")
        {
            try
            {
                ...
                dt = objbal.offer_Select(" where int_small_business_id = " + Session["sid"], pageindex, 10, out totalcount, sortorder, columnname);
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            //    {
            //        query = " and str_offer_name like '%" + txtsearch.Value + "%'";
            //    }
            //    BindGrid(query, 1);
            //}
            //catch (Exception ex)
