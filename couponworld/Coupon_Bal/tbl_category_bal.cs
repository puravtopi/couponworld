...
{
    public class tbl_category_bal : Connection_Bal
    {

        public SqlCommand gComm;

        public int category_insert(tbl_category_entity objentity)
        {
            int val = 0;
            try
            {
                gComm = new SqlCommand("usp_insert_tbl_category", gConn);
                gComm.CommandType = CommandType.StoredProcedure;

                gComm.Parameters.AddWithValue("@str_category_name", objentity.str_category_name);
        ...
        public int category_delete(tbl_category_entity objentity)
        {
            int dbval = 0;
            try
            {
                gComm = new SqlCommand("usp_delete_tbl_category", gConn);
                gComm.CommandType = CommandType.StoredProcedure;
        ...
        public int category_Update(tbl_category_entity objentity)
        {
            int bval = 0;

            try
            {
                gComm = new SqlCommand("usp_update_tbl_category", gConn);
                gComm.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet category_Select(string query, int pageindex, int pagesize, out int totalrecords, string sortorder = "asc", string columnname = "str_category_name")
        {
            ...
            try
            {
                gComm = new SqlCommand("usp_select_tbl_category", gConn);
                gComm.CommandType = CommandType.StoredProcedure;
