<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="edit_category.aspx.cs" Inherits="Coupon.Admin.category_details" %>
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="rf1" runat="server" ErrorMessage="Enter Valid Category" ControlToValidate="txt_cat" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                </div>                
