<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="edit_organization.aspx.cs" Inherits="Coupon.Admin.organization_details" %>
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                ...
                <asp:UpdatePanel runat="server" ID="upEmail">
                    <ContentTemplate>
                        <div class="form-group">
                           ...
                           <%-- <asp:RequiredFieldValidator ID="rf10" runat="server" ErrorMessage="Enter Valid Primary Email Id" ControlToValidate="txt_email_p" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                ...
                <div class="form-group">
                  ...
                  <%--  <asp:RequiredFieldValidator ID="rf26" runat="server" ErrorMessage="Enter Valid Primary Telephone" ControlToValidate="txt_telephone_p" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ErrorMessage="Invalid Teleohone" ControlToValidate="txt_telephone_p" ValidationExpression="\d+" Display="Dynamic" ForeColor="Red"></asp:RegularExpressionValidator>
                </div>
                <div class="form-group">
                    <label>Contact(P)</label>
                    <asp:TextBox ID="txt_contact_1_p" runat="server" CssClass="form-control" MaxLength="15"></asp:TextBox>
               <%--     <asp:RequiredFieldValidator ID="rf25" runat="server" ErrorMessage="Enter Valid Primary Contact" ControlToValidate="txt_contact_1_p" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="Invalid Contact" ControlToValidate="txt_contact_1_p" ValidationExpression="^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$" Display="Dynamic" ForeColor="Red"></asp:RegularExpressionValidator>
                </div>

                <div class="form-group">
                    <label>Email ID(S)</label>
                    <asp:TextBox ID="txt_email_s" runat="server" CssClass="form-control"></asp:TextBox>
                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter Valid Secondary Email Id" ControlToValidate="txt_email_s" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                ...
                <div class="form-group">
                    ...
                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter Valid Secondary Telephone" ControlToValidate="txt_tele_s" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ErrorMessage="Invalid Teleohone" ControlToValidate="txt_tele_s" ValidationExpression="\d+" Display="Dynamic" ForeColor="Red"></asp:RegularExpressionValidator>
                </div>

                <div class="form-group">
                    <label>Contact(s)</label>
                    <asp:TextBox ID="txt_contact_2_s" runat="server" CssClass="form-control" MaxLength="15"></asp:TextBox>
                    <%--<asp:RequiredFieldValidator ID="rf27" runat="server" ErrorMessage="Enter Valid Secondary Contact" ControlToValidate="txt_contact_2_s" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Invalid Contact" ControlToValidate="txt_contact_2_s" ValidationExpression="^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$" Display="Dynamic" ForeColor="Red"></asp:RegularExpressionValidator>
                </div>
                <div class="form-group">
                    <label>Organization Type</label>
                    <asp:DropDownList ID="ddl_org_type" runat="server" CssClass="form-control">
                    </asp:DropDownList>
                    <%--<asp:RequiredFieldValidator ID="rf22" runat="server" ErrorMessage="Select Organization Type" ControlToValidate="ddl_org_type" Display="Dynamic" ForeColor="Red" InitialValue="0"></asp:RequiredFieldValidator>--%>
                </div>
