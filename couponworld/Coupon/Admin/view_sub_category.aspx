<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="view_sub_category.aspx.cs" Inherits="Coupon.Admin.view_sub_category" %>
        ...
        <div class="box-body">
            <asp:UpdatePanel runat="server" ID="upMain">
                <ContentTemplate>
                    ...
                    <asp:LinkButton ID="lnk_del" runat="server" CommandArgument='<%# Eval("int_sub_category_id") %>' OnClick="lnk_del_Click" OnClientClick="return confirm('Are you sure you want to delete.?')">Delete selected</asp:LinkButton>
                    <br />
                    <asp:Repeater ID="rpview" runat="server">
                                    ...
                                    <table class="table table-bordered" id="tblCustomers" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <asp:LinkButton runat="server" ID="lnk_org_name" CausesValidation="false" CommandArgument="str_sub_category_name" OnClick="lnk_org_name_Click">Sub Category Name</asp:LinkButton>
                                                </th>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:HiddenField ID="hdnID" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "int_sub_category_id") %>' />

                                    <%# Eval("str_sub_category_name") %></td>
                                <%--<td><%# Eval("str_icon")  %></td>--%>
                                <%-- <td></td>--%>
                                <td>
                                    <a href="<%# "edit_sub_category.aspx?sub_cat_id="+Eval("int_sub_category_id") %>" class="btn btn-primary">Edit</a>
                                </td>
                                <%--                        <td>
