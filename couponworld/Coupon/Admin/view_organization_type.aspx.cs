...
{
    public partial class view_organization_type : System.Web.UI.Page
    {
        ...
        protected void BindGrid(string query, int pageindex, string columnname = "str_organization_type", string sortorder = "asc")
        {
            try
            {
                int totalcount;
                ...
                dt = objbal.organization_type_Select(query, pageindex, 10, out totalcount, sortorder, columnname);
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    query = " where str_organization_type like '%" + txtsearch.Value + "%' ";
                }
                BindGrid(query, 1);
            }
            catch (Exception ex)
        ...
        protected void lnk_del_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tbl_organization_type_bal objbal = new tbl_organization_type_bal();
                tbl_organization_type_entity objentity = new tbl_organization_type_entity();
                ...
                for (int i = 0; i < rpview.Items.Count; i++)
                {
                    ...
                    {
                        objentity.int_organization_type_id = Convert.ToInt16(hdnID.Value);
                        objbal.organization_types_delete(objentity);
                    }
                }
                BindGrid("", 1);
            }
        ...
        {
            Response.Redirect("edit_org_type.aspx");
        }
