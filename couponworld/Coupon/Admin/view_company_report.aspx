<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="view_company_report.aspx.cs" Inherits="Coupon.Admin.view_company_report" %>
            ...
            <asp:UpdatePanel runat="server" ID="upMain">
                <ContentTemplate>
                    ...
                    <div class="form-inline">
                        ...
                        <br />
                        <div class="col-lg-4">
                            <input type="text" runat="server" id="txt_member_name" class="form-control" style="width: 100%" placeholder="Search By Consumer Name" />
                        </div>
                        <div class="col-lg-4">
                            <input type="text" runat="server" id="txt_member_no" class="form-control" style="width: 100%" placeholder="Search By Consumer Number" />
                        </div>
                        <div class="col-lg-3">
                    ...
                    <asp:Repeater ID="rpview" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <%-- <td></td>--%>
                                <%--<td>
                                    <a href="<%# "company_details.aspx?cid="+Eval("int_company_id") %>" class="btn btn-primary">Edit</a>
                                --%>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
            ...
            <label runat="server" id="lbl_total_page" style="display: inline"></label>
                    ...
                    <asp:GridView runat="server" ID="gvtemp" AutoGenerateColumns="false" Visible="false">
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Name" DataField="str_company_name" />
                            ...
                            <asp:BoundField HeaderText="Company ID" DataField="int_company_id" />
                            <asp:BoundField HeaderText="Company Type" DataField="str_company_type" />
