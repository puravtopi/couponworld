<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="org_request.aspx.cs" Inherits="Coupon.Admin.org_request" %>
                                    ...
                                    <table class="table table-bordered" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <asp:LinkButton runat="server" ID="lnk_retailer_name" CausesValidation="false" CommandArgument="str_organization_name" OnClick="lnk_retailer_name_Click">Org Name</asp:LinkButton></th>
                                                <th>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:LinkButton runat="server" ID="lnk_view" CausesValidation="false" CssClass="btn btn-primary" Text="Activate" OnClick="lnk_view_Click" CommandArgument='<%# Eval("int_organization_id") %>'></asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
        ...
        <div class="modal-dialog" style="width: 82%;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" style="text-align: left;">Organization</h4>
                </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class=" col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Select Retailer Type" ValidationGroup="active" ControlToValidate="ddl_type" Display="Dynamic" ForeColor="Red" InitialValue="0"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <%--<div class=" col-lg-4">
                                            <div class="form-group">
