...
{
    public class tbl_retailer_social_bal : Connection_Bal
    {
        public SqlCommand gComm;

        public int retailer_social_insert(tbl_retailer_social_entity objentity)
        {
            int val = 0;
            try
            {
                gComm = new SqlCommand("usp_insert_tbl_retailer_social", gConn);
        ...
        public int retailer_social_delete(tbl_retailer_social_entity objentity)
        {
            int dbval = 0;
            try
            {
                gComm = new SqlCommand("usp_delete_tbl_retailer_social", gConn);
                gComm.CommandType = CommandType.StoredProcedure;

                gComm.Parameters.AddWithValue("@int_social_id", objentity.int_social_id);
        ...
        public int retailer_social_Update(tbl_retailer_social_entity objentity)
        {
            int bval = 0;

            try
            {
                gComm = new SqlCommand("usp_update_tbl_retailer_social", gConn);
                gComm.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet retailer_social_Select(string query, int pageindex, int pagesize, out int totalrecords, string sortorder = "asc", string columnname = "str_retailer_name")
        {
            ...
            try
            {
                gComm = new SqlCommand("usp_select_tbl_retailer_social", gConn);
                gComm.CommandType = CommandType.StoredProcedure;
