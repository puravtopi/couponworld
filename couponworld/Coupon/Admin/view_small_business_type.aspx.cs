...
{
    public partial class view_small_business_type : System.Web.UI.Page
    {
        ...
        protected void BindGrid(string query, int pageindex, string columnname = "str_small_business_type_name", string sortorder = "asc")
        {
            try
            {
                int totalcount;
                ...
                dt = objbal.small_business_types_Select(query, pageindex, 10, out totalcount, sortorder, columnname);
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    query = " where str_small_business_type_name like '%" + txtsearch.Value + "%' ";
                }
                BindGrid(query, 1);
            }
            catch (Exception ex)
        ...
        protected void lnk_del_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tbl_small_business_type_bal objbal = new tbl_small_business_type_bal();
                tbl_small_business_type objentity = new tbl_small_business_type();
                ...
                for (int i = 0; i < rpview.Items.Count; i++)
                {
                    ...
                    {
                        objentity.int_small_business_type_id = Convert.ToInt16(hdnID.Value);
                        objbal.small_business_types_delete(objentity);
                    }
                }
                BindGrid("", 1);
            }
        ...
        {
            Response.Redirect("edit_small_business_type.aspx");
        }
