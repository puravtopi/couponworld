<%@ Page Title="" Language="C#" MasterPageFile="~/other.Master" AutoEventWireup="true" CodeBehind="view_organizations.aspx.cs" Inherits="Coupon.view_organizations" %>
                                ...
                                <ItemTemplate>
                                    <div class="col-md-4 product-grids" style="margin-top: 1em;">
                                        <div class="agile-products" style="height: 300px; width: 260px;">
                                            ...
                                            <a href="<%#  ResolveUrl ( string.Format("~/orgnization/{0}/{1}",Eval("str_corporate_name").ToString().ToLower().Replace(" ","-").Replace(".","")   ,  Eval("int_organization_id"))) %>">
                                                <img src='<%# "../Admin/org_logo/" + Eval("str_logo_img") %>' class="img-responsive" alt="" style="height: 170px;" />
                                                <div class="agile-product-text">
                                                    <h5><a href="<%#  ResolveUrl ( string.Format("~/orgnization/{0}/{1}",Eval("str_corporate_name").ToString().ToLower().Replace(" ","-").Replace(".","")   ,  Eval("int_organization_id"))) %>">
                                                        <asp:Label ID="lbl_name" runat="server" Text='<%# Eval("str_corporate_name") %>'></asp:Label></a></h5>
                                                    <h6>
                                                        <asp:Label runat="server" ID="lbl_dis" Text='<%# Eval("str_organization_name")%>'></asp:Label></h6>
                                                    ...
                                                    <a href="<%#  ResolveUrl ( string.Format("~/orgnization/{0}/{1}",Eval("str_corporate_name").ToString().ToLower().Replace(" ","-").Replace(".","")   ,  Eval("int_organization_id"))) %>" class="w3ls-cart pw3ls-cart"><i class="" aria-hidden="true"></i>View Organization</a>
