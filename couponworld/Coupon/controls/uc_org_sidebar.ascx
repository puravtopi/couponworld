<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_org_sidebar.ascx.cs" Inherits="Coupon.controls.uc_org_sidebar" %>
...
<div>
    <ul style="list-style-type: none">
        <li>
            ...
            <h5 class="item_name"><a href='<%= ResolveUrl("~/org-profile") %>'><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Profile</a>
            </h5>

            <hr />

            <h5 class="item_name">
                <a href="view_deals_retailer.aspx"><i class="fa fa-gift" aria-hidden="true"></i>&nbsp;Statics</a>
            </h5>

            <hr />

            <h5 class="item_name">
                <a href="view_user_transaction.aspx"><i class="fa fa-money" aria-hidden="true"></i>&nbsp;Transactions</a>
            </h5>
