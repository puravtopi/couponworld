<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="view_small_business_report.aspx.cs" Inherits="Coupon.Admin.view_small_business_report" %>
            ...
            <asp:UpdatePanel runat="server" ID="upMain">
                <ContentTemplate>
                    <div class="form-inline">
                        ...
                        <br />
                        <div class="col-lg-4">
                            <input type="text" runat="server" id="txt_small_business_name" class="form-control" style="Width: 100%" placeholder="Search By SB Name" />
                        </div>
                        <div class="col-lg-4">
                            <input type="text" runat="server" id="txt_small_business_no" class="form-control" style="Width: 100%" placeholder="Search By SB Number" />
                        </div>
                        <div class="col-lg-3">
                    ...
                    <asp:Repeater ID="rpview" runat="server">
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <asp:LinkButton runat="server" ID="lnk_retailer_name" CausesValidation="false" CommandArgument="str_name" OnClick="lnk_retailer_name_Click">DBA Name</asp:LinkButton></th>
                                                <th>
                                                ...
                                                <th>
                                                    <asp:LinkButton runat="server" ID="LinkButton12" CausesValidation="false" CommandArgument="int_small_business_id" OnClick="lnk_retailer_name_Click">SB No.</asp:LinkButton>
                                                </th>
                                                <th>
                                                    <asp:LinkButton runat="server" ID="LinkButton13" CausesValidation="false" CommandArgument="str_type_name" OnClick="lnk_retailer_name_Click">SB Type</asp:LinkButton>
                                                </th>
                                                <th>
                                                    <asp:LinkButton runat="server" ID="LinkButton14" CausesValidation="false" CommandArgument="str_share_type" OnClick="lnk_retailer_name_Click">Fee Type</asp:LinkButton>
                                                </th>
                                                <th style="width: 1%">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <%-- <td></td>--%>
                                <%--  <td>
                                    <a href="<%# "small_business_details.aspx?sbid="+Eval("int_small_business_id") %>" class="btn btn-primary">Edit</a>--%>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
                            </tbody>
                    ...
                    <asp:Button runat="server" ID="btn_pdf" Text="Pdf File" OnClick="btn_pdf_Click" CssClass="btn btn-primary" />
                    <%} %>
            ...
            <label runat="server" id="lbl_total_page" style="display: inline"></label>
                    ...
                    <asp:GridView runat="server" ID="gvtemp" AutoGenerateColumns="false" Visible="false">
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Small Business ID" DataField="int_small_business_id" />
                            <asp:BoundField HeaderText="Small Business Type" DataField="str_small_business_type_name" />
