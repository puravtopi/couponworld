<%@ Page Title="" Language="C#" MasterPageFile="~/retailer.Master" AutoEventWireup="true" CodeBehind="view_deals_retailer.aspx.cs" Inherits="Coupon.view_deals_retailer" %>
        ...
        <div class="container">
            ...
            <div class="col-md-10 product-w3ls">
                ...
                <div class="single-top-right col-md-6">
                    <a href="<%= ResolveUrl("~/deal-details") %>" class="btn btn-active" style="float: right">Add Deals</a>
                </div>
                                ...
                                <ItemTemplate>
                                    <div class="col-md-4 product-grids">
                                        <div class="agile-products">
                                            ...
                                            <%--<a href="<%#  ResolveUrl(string.Format("~/deal-details/{0}/{1}",Eval("str_offer_name").ToString().ToLower().Replace(" ","-").Replace("&","and").Replace(".",""),  Eval("int_offer_id"))) %>"></a>--%>

                                            <a href="<%#  ResolveUrl ( string.Format("~/retailer-deal-details/{0}/{1}",Eval("str_offer_name").ToString().ToLower().Replace(" ","-").Replace("%","percantage")   ,  Eval("int_offer_id"))) %>">
                                                <img src='<%# "../Admin/offer_image/" + Eval("str_img") %>' class="img-responsive" alt="" style="height: 170px;" />
                                                <div class="agile-product-text">
                                                    <h5><a href="<%#  ResolveUrl ( string.Format("~/retailer-deal-details/{0}/{1}",Eval("str_offer_name").ToString().ToLower().Replace(" ","-").Replace("%","percantage")   ,  Eval("int_offer_id"))) %>">
                                                    ...
                                                    <a href="<%#  ResolveUrl ( string.Format("~/retailer-deal-details/{0}/{1}",Eval("str_offer_name").ToString().ToLower().Replace(" ","-").Replace("%","percantage")   ,  Eval("int_offer_id"))) %>" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i>Edit</a>
