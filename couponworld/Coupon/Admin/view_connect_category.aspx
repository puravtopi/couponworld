<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="view_connect_category.aspx.cs" Inherits="Coupon.Admin.view_connect_category" %>
                    ...
                    <asp:Repeater ID="rpview" runat="server">
                                    ...
                                    <table class="table table-bordered" style="width: 100%" id="tbl_data">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <asp:LinkButton runat="server" ID="lnk_cat_name" CausesValidation="false" CommandArgument="str_cat" OnClick="lnk_cat_name_Click">City Name</asp:LinkButton></th>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:HiddenField ID="hdnID" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "int_connect_cat_id") %>' />
                                    <%# Eval("str_cat") %></td>
                              
                                <%-- <td></td>--%>
                                <td>
                                    <a href="<%# "edit_connect_category.aspx?cat_id="+Eval("int_connect_cat_id") %>" class="btn btn-primary">Edit</a>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
                            </tbody>
