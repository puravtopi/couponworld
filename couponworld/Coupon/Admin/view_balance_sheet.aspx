<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="view_balance_sheet.aspx.cs" Inherits="Coupon.Admin.view_balance_sheet" %>
        ...
        <div class="box-body">
            <asp:UpdatePanel runat="server" ID="upMain">
                <ContentTemplate>
                    ...
                    <asp:Label runat="server" ID="lbl_total_amt"></asp:Label>
                    ...
                    <asp:Repeater ID="rpview" runat="server" OnItemDataBound="rpview_ItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <td>$
                                        <asp:Label runat="server" ID="lbl_purchase" Text='<%# Eval("dec_puchase_amt") %>'></asp:Label>
                                    </td>
                        ...
                        <FooterTemplate>
                            <tr class="subHeadingTr" style="font-weight: bold; background-color: #e8e8e8;">
                                <td colspan="16" style="text-align: right; font-size: larger;"><b>Totals</b>
                                </td>
