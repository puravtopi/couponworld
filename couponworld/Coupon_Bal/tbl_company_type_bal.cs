...
{
    public class tbl_company_type_bal : Connection_Bal
    {
        public SqlCommand gComm;


        public DataSet company_type_Select(string query, int pageindex, int pagesize, out int totalrecords, string sortorder = "asc", string columnname = "str_company_type")
        {
            ...
            try
            {
                gComm = new SqlCommand("usp_select_tbl_company_type", gConn);
        ...
        public int company_types_insert(tbl_company_type_entity objentity)
        {
            int val = 0;
            try
            {
                gComm = new SqlCommand("usp_insert_tbl_company_type", gConn);
                gComm.CommandType = CommandType.StoredProcedure;

                gComm.Parameters.AddWithValue("@str_company_type", objentity.str_company_type);
        ...
        public int company_types_delete(tbl_company_type_entity objentity)
        {
            int dbval = 0;
            try
            {
                gComm = new SqlCommand("usp_delete_tbl_company_type", gConn);
                gComm.CommandType = CommandType.StoredProcedure;
        ...
        public int company_types_Update(tbl_company_type_entity objentity)
        {
            int bval = 0;

            try
            {
                gComm = new SqlCommand("usp_update_tbl_company_type", gConn);
                gComm.CommandType = CommandType.StoredProcedure;
